...
3. Enable the object cache under _Settings -> Redis_.  After doing so, you can optionally toggle it off at runtime via adding this to `wp-config.php`:
```php
define('REDIS_OBJECT_CACHE_DISABLE', true);
```
